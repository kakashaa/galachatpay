...
const FAQ_LIST: FAQ[] = [
  ...
  },
  {
    ...
    answer: "السحب الفوري:\n1⃣ اختر 'سحب فوري' من صفحة السحب\n2⃣ اختر دولة الداعم (أمريكا/اليمن/السعودية)\n3⃣ شارك تفاصيل الحساب مع الداعم\n4⃣ الداعم يحول ويرسلك الإيصال\n5⃣ ارفع الإيصال مع تفاصيل الطلب\n\nالحسابات المتاحة: CashApp, Zelle, Chime, Apple Pay, الكريمي (ريال/دولار/يمني), الراجحي.",
    ...
    (topic: string) => {
      switch (topic) {
        ...
        case "show_faq": {
          ...
          addBotMessage(
            `📖 **الأسئلة الشائعة:**\n\n${faqText}\n\n✍ اكتب سؤالك أو رقم السؤال وبجاوبك فوراً!`,
            [{ label: "القائمة الرئيسية", value: "main_menu" }]
          );
          break;
        }
        ...
        case "salary_table": {
          addBotMessage(
            `**سعر الصرف:**\n` +
              ...
              `نجوم: 10 نجوم = $50\n\n` +
              `📅 رفع الراتب: من 1 إلى 5 من الشهر\n` +
              `خصم 20% عند عدم إكمال الأيام/الساعات`,
            [
              { label: "اسحب راتبك ←", value: "nav:/salary" },
        ...
        case "policy_charge":
          addBotMessage(
            `**سياسة وكالات الشحن:**\n\n` +
              ...
              `ممنوع خداع المستخدمين وإلا إنهاء التعاون`,
            [
              { label: "شوف السياسة كاملة ←", value: "nav:/policy" },
              { label: "القائمة الرئيسية", value: "main_menu" },
            ]
        ...
        case "live_support": {
          ...
          if (isEligible) {
            ...
            addBotMessage(
              `عذراً، الدعم السريع المباشر متاح فقط لـ:\n` +
                `• أصحاب VIP 5 و VIP 6\n` +
                `• الوكلاء\n\n` +
        ...
        <DialogContent className="max-w-xs rounded-2xl text-center">
          ...
          <div className="space-y-4 py-2">
            ...
            <p className="text-sm text-muted-foreground">
              إذا طلعت من المحادثة بينحذف كل شي كتبته!
            </p>
            <Button
