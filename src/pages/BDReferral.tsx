...
import { CheckCircle, Loader2, AlertCircle, User, ShieldAlert } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6" dir="rtl">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-muted-foreground max-w-xs mx-auto">أدخل آيدي حسابك في غلا لايف للتسجيل لدى مطور الأعمال</p>
        </div>
