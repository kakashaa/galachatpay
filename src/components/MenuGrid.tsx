...
import {
  ...
  Sparkles, PlayCircle, Frame, FileText, Award, Briefcase,
...
const menuItems: MenuItem[] = [
  ...
  { icon: Award, label: "مركز الشارة", route: "/hairs", bg: "rgba(251,191,36,0.12)", iconColor: "text-amber-400", banKey: "hairs" },
