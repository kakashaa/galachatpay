...
const stepsEntry = [
  ...
  {
    title: "معرفات مميزة بالنجوم ⭐",
    description: "10 نجوم = معرف AAAAA (خماسي موحد)\n9 نجوم = معرف AAAAB (خماسي مع حرف)\n8 نجوم = معرف AAABB (ثلاثي + ثنائي)\n7 نجوم = معرف AABABA (نمط متكرر)",
  },
  {
    title: "تحويل النجوم لكاش 💰",
    description: "تقدر تحول نجومك إلى دولارات!\nكل نجمة = $5 دولار\n10 نجوم = $50 دولار\nيتم إنشاء طلب سحب ويراجعه الأدمن.",
  },
  {
    title: "مثال عملي",
