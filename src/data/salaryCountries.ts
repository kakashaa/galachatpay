...
export const countries: CountryConfig[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      { id: "mumeez", label: "شبكة المميز", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "hattar", label: "شبكة الهتار", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "mal_money", label: "شبكة مال موني", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "barq", label: "شبكة البرق", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "alsarea", label: "السريع للحوالات", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "nasser", label: "شبكة الناصر", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "muheet", label: "شبكة المحيط", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "ameri_cash", label: "شبكة العامري كاش", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "yeah_money", label: "ياه موني", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "hazmi", label: "شبكة حزمي تحويل", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "jeeb", label: "حوالات جيب", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "imtiaz", label: "شبكة الامتياز", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "najm", label: "شبكة النجم", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "yemen_express", label: "شبكة يمن اكسبرس", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "hb_fast", label: "شبكة الحوشبي (إتش بي)", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "akooa", label: "شبكة الاكوع", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "yemeni_net", label: "الشبكة اليمنية للتحويلات", requiresAccount: true, placeholder: "الاسم الكامل كما في الهوية" },
      USDT_ERC20,
      MONEYGRAM,
      WESTERN_UNION,
    ],
