...
export const countries: CountryConfig[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      { id: "mumeez", label: "شبكة المميز", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "hattar", label: "شبكة الهتار", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "mal_money", label: "شبكة مال موني", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "barq", label: "شبكة البرق", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "alsarea", label: "السريع للحوالات", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "nasser", label: "شبكة الناصر", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "muheet", label: "شبكة المحيط", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "ameri_cash", label: "شبكة العامري كاش", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "yeah_money", label: "ياه موني", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "hazmi", label: "شبكة حزمي تحويل", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "jeeb", label: "جيب", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "imtiaz", label: "شبكة الامتياز", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "najm", label: "شبكة النجم", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "yemen_express", label: "شبكة يمن اكسبرس", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "hb_fast", label: "شبكة الحوشبي (إتش بي)", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "akooa", label: "شبكة الاكوع", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      { id: "yemeni_net", label: "الشبكة اليمنية للتحويلات", requiresAccount: true, requiresPhone: true, placeholder: "الاسم الكامل كما في الهوية" },
      USDT_ERC20,
      MONEYGRAM,
      WESTERN_UNION,
    ],
